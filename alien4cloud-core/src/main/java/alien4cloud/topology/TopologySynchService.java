...
@Service
@Slf4j
public class TopologySynchService {
     ...
     */
    public void synchronizeTopology(Collection<CSARDependency> updatedDependencies, Topology topology) {
        ...
        for (CSARDependency updatedDependency : updatedDependencies) {
            synchNodeTemplates(topology, updatedDependency, context);
            synchRelationships(topology, updatedDependency, context);
        }
    ...
    private void synchNodeTemplates(Topology topology, CSARDependency updatedDependency, TopologyContext context) {
    ...
    private void synchRelationships(Topology topology, CSARDependency updatedDependency, TopologyContext context) {
        ...
        for (Entry<String, NodeTemplate> entry : nodeTemplates.entrySet()) {
            ...
            for (String relationshipName : relationshipNames) {
                ...
                if (isFrom(relationshipType, updatedDependency)) {
                    ...
                    nodeTemplate.getRelationships().remove(relationshipName);
                    boolean isSynchronized = trySynchRelationship(nodeTemplate, relationshipType, relationshipName, relationshipTemplate, topology, context);
     ...
     */
    private boolean trySynchRelationship(NodeTemplate nodeTemplate, IndexedRelationshipType relType, String relationshipName,
